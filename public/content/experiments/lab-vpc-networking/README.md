...
The deployment is handled automatically via the UI buttons above. The process:

1. Click **Deploy Lab** button
2. Wait 5-7 minutes for infrastructure deployment
3. Access console URLs provided in the outputs
4. Complete the lab exercises below
5. Click **Cleanup Lab** when finished
