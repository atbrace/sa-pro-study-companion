...
/**
 * Shared sidebar content used by both desktop Sidebar and MobileSidebar.
 * The onNavigate callback is used to close the mobile drawer on navigation.
 */
export function SidebarContent({ sidebarHierarchy, examId, onNavigate }: SidebarContentProps) {
  ...
  return (
    <>
      ...
      <nav className="flex-1 overflow-y-auto space-y-1 p-4">
        ...
        <StudyTreeNav hierarchy={sidebarHierarchy} examId={examId} onNavigate={onNavigate} />
