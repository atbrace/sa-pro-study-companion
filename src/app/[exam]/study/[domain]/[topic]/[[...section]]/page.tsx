    ...
    return (
      <div className="container py-8 max-w-4xl">
        ...
        <div className="mb-6 flex items-center gap-2 text-sm text-muted-foreground">
          <Link href={`/${examId}/study`} className="hover:text-foreground">
            Study
          </Link>
          <span>/</span>
          <Link href={`/${examId}/study/${domainId}`} className="hover:text-foreground">
    ...
    return (
      <div className="container py-8 max-w-4xl">
        ...
        <div className="mb-6 flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <span>/</span>
          <Link href={`/${examId}/study/${domainId}/${topicId}${firstSection ? `/${firstSection.id}` : ''}`} className="hover:text-foreground">
