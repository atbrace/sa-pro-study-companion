...
export default async function DomainPage({ params }: PageProps) {
  const { exam: examId, domain: domainId } = await params;
      ...
      {domain.meta.examTasks && domain.meta.examTasks.length > 0 && (
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>
              Key areas covered in this domain according to the exam guide
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <CardContent>
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="ghost" size="sm" asChild>
                    <Link href={`/${examId}/study/${domainId}/${topic.meta.id}`}>
                      Study Topic
